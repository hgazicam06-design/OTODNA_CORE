# 🌍 OTODNA KÜRESEL SİBER MAHKEME PROTOKÖLÜ (INTERNATIONAL CYBER COURT)

Türkiye'de "Siber Mahkeme" TKHK (Tüketici Kanunu) bazlı çalışırken, OtoDNA'nın küresel (Yurt Dışı) versiyonu için Karargah tamamen "Çok Hukuklu Yapay Zeka (Multi-Jurisdictional AI)" mimarisine geçer. Sistem, aracın bulunduğu ülkeye ve tescil edildiği devlete göre otonom olarak şekil değiştirir.

---

## 1. YEREL YASALARA OTONOM ADAPTASYON (AI JURISDICTION)
Gemini AI Hakimi (CorporateLegalEngine), GPS veya araç plakası üzerinden kullanıcının hangi ülkede olduğunu anlar ve o ülkenin tüketici yasalarını (Data Training) devreye sokar:

*   **🇺🇸 Amerika Birleşik Devletleri (Lemon Laws):**
    *   ABD'deki fabrikasyon hatalı araçlar için uygulanan **"Lemon Law" (Limon Yasası)** kuralları işletilir. Eğer bir araç ABD'de aynı arızadan 3 veya 4 kez servise girmişse (eyalete göre değişir), Siber Mahkeme otonom olarak üreticiye karşı "Geri Alım (Buyback)" veya "Misliyle Değişim" dilekçesi (Demand Letter) hazırlar.
*   **🇪🇺 Avrupa Birliği (Directive 1999/44/EC & BGB):**
    *   AB ülkelerinde "2 Yıllık Yasal Garanti" kuralları katıdır. Almanya'daki bir kullanıcı için Alman Medeni Kanunu (BGB) kapsamında **"Mängelrüge" (Ayıp İhbarı)** veya **"Rücktritt vom Kaufvertrag" (Sözleşmeden Dönme)** dilekçeleri üretilir.
...
## 4. INTERPOL VE ÇALINTI ARAÇ BLOKAJI
Uluslararası ticaretin en büyük riski çalıntı araçlardır.
*   OtoDNA terminalinden (Siber Göz) bir aracın şasesi (VIN) okutulduğunda, sistem arka planda otonom olarak Uluslararası Çalıntı Araç Veritabanlarını (Interpol Stolen Motor Vehicles) sorgular.
*   Eğer araç çalıntıysa, sistem işlemi atomik düzeyde dondurur (işlem yapılamaz) ve kolluk kuvvetleri için adli bir log dosyası oluşturur.

## 5. GLOBAL "BUY BOX" VE SINIR ÖTESİ TAHKİM (B2B ARBITRATION)
OtoDNA "Trendyol/Amazon" modelinde Dubai'deki bir kullanıcı, Türkiye'deki bir OtoDNA bayisinden yedek parça aldığında ve parça kusurlu çıktığında:
*   Karargah, ülkeler arası mahkeme beklemeden "Global Tahkim (Hakem)" görevini üstlenir.
*   Eğer Türk bayisi hatalıysa, Stripe/Uluslararası ödeme ağ Geçidi üzerinden "Atomik İade" otonom olarak gerçekleşir. %12 Karargah komisyonu kesilir, bayinin "Siber İtibar Puanı (Global Trust Score)" düşürülür. OtoDNA, sınır ötesi ticarette tek güven otoritesi olur.
