...
class SiberCiroRaporlama extends StatefulWidget {
  ...
  SiberCiroRaporlama({super.key, this.isDistributor = false});
...
class _SiberCiroRaporlamaState extends State<SiberCiroRaporlama> {
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        _buildCiroOzeti(),
                        SizedBox(height: 32),
                        Text("FİNANSAL İSTİHBARAT", style: TextStyle(color: Colors.white54, fontSize: 11, fontWeight: FontWeight.w900, letterSpacing: 2, fontFamily: 'Avenir')),
                        SizedBox(height: 16),
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              ...
              Text('C İ R O   R A D A R I', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w900, fontSize: 13, letterSpacing: 3, fontFamily: 'Avenir')),
              Container(padding: EdgeInsets.all(8), decoration: BoxDecoration(color: primaryCyan.withOpacity(0.1), shape: BoxShape.circle, border: Border.all(color: primaryCyan.withOpacity(0.5))), child: Icon(Icons.account_balance_wallet_outlined, color: primaryCyan, size: 18)),
            ],
          ),
        ),
      ),
  ...
  Widget _buildCiroOzeti() {
    return Center(
      child: Container(
        ...
        child: Column(
          children: [
            Text("NET SİBER KAZANÇ", style: TextStyle(color: Colors.white54, fontSize: 10, fontWeight: FontWeight.w900, letterSpacing: 2, fontFamily: 'Avenir')),
            SizedBox(height: 8),
            Text("₺${netKazanc.toStringAsFixed(2)}", style: TextStyle(color: primaryCyan, fontSize: 28, fontWeight: FontWeight.w900, letterSpacing: -1, fontFamily: 'Avenir')),
          ],
        ),
      ),
    );
  ...
  Widget _buildSonIslemler() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text("SON ONAYLANAN İŞLEMLER", style: TextStyle(color: Colors.white54, fontSize: 11, fontWeight: FontWeight.w900, letterSpacing: 2, fontFamily: 'Avenir')),
        SizedBox(height: 16),
  ...
  Widget _buildIslemKarti(String baslik, String tarih, double tutar) {
    ...
    return Container(
      ...
      child: Row(
        children: [
          Container(padding: EdgeInsets.all(12), decoration: BoxDecoration(color: primaryCyan.withOpacity(0.1), shape: BoxShape.circle), child: Icon(Icons.check_circle_outline, color: primaryCyan, size: 20)),
          SizedBox(width: 16),
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(baslik, style: TextStyle(color: Colors.white, fontSize: 13, fontWeight: FontWeight.bold, fontFamily: 'Avenir')),
                SizedBox(height: 4),
                Text(tarih, style: TextStyle(color: Colors.white54, fontSize: 10, fontFamily: 'Avenir')),
              ],
            ),
          ),
          Column(
            ...
            children: [
              Text("+₺${net.toStringAsFixed(2)}", style: TextStyle(color: primaryCyan, fontSize: 14, fontWeight: FontWeight.w900, fontFamily: 'Avenir')),
              SizedBox(height: 4),
              Text("Brüt: ₺${tutar.toStringAsFixed(0)}", style: TextStyle(color: Colors.white38, fontSize: 9, fontFamily: 'Avenir')),
            ],
          )
        ],
      ),
