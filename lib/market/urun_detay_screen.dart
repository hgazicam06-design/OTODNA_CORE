...
class UrunDetayScreen extends StatefulWidget {
  ...
  UrunDetayScreen({super.key, required this.ilanId, required this.urunVerisi});
...
class _UrunDetayScreenState extends State<UrunDetayScreen> {
              ...
              children: [
                ...
                Expanded(
                  child: SingleChildScrollView(
                    ...
                    padding: EdgeInsets.only(bottom: 120), // Alt bar için boşluk
                    child: Column(
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              ...
              Text('S İ B E R   D E T A Y', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w900, fontSize: 13, letterSpacing: 3, fontFamily: 'Avenir')),
              Row(
                children: [
                  Container(padding: EdgeInsets.all(8), decoration: BoxDecoration(color: Colors.white.withOpacity(0.05), shape: BoxShape.circle), child: Icon(Icons.share_outlined, color: Colors.white, size: 20)),
                  SizedBox(width: 8),
                  GestureDetector(
                    onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => SiberSepetScreen())),
                    child: Container(padding: EdgeInsets.all(8), decoration: BoxDecoration(color: primaryCyan.withOpacity(0.1), shape: BoxShape.circle, border: Border.all(color: primaryCyan.withOpacity(0.5))), child: Icon(Icons.shopping_cart_outlined, color: primaryCyan, size: 20)),
                  ),
                ],
              )
            ],
    ...
    return Column(
      children: [
        ...
        Container(
          ...
          child: Stack(
            children: [
              Positioned(top: 16, left: 16, child: Container(padding: EdgeInsets.symmetric(horizontal: 12, vertical: 6), decoration: BoxDecoration(color: SiberTema.kanKirmizi, borderRadius: BorderRadius.circular(8)), child: Text("- %15", style: TextStyle(color: Colors.white, fontWeight: FontWeight.w900, fontSize: 12)))),
            ],
          ),
        ),
        ...
        Container(
          ...
          child: ListView.builder(
            scrollDirection: Axis.horizontal, itemCount: resimler.length, padding: EdgeInsets.symmetric(horizontal: 16),
            itemBuilder: (context, index) {
              bool seciliMi = _seciliResimIndex == index;
              return GestureDetector(
                onTap: () => setState(() => _seciliResimIndex = index),
                child: Container(
                  width: 60, margin: EdgeInsets.only(right: 12),
  ...
  Widget _buildSiberKunye() {
    return Padding(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(baslik, style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.w900, height: 1.3, fontFamily: 'Avenir')),
          SizedBox(height: 12),
          Row(
            children: [
              Row(children: List.generate(5, (index) => Icon(Icons.star, color: siberGold, size: 16))),
              SizedBox(width: 8),
              Text("4.9 (128 Değerlendirme)", style: TextStyle(color: Colors.white54, fontSize: 12, fontWeight: FontWeight.bold, fontFamily: 'Avenir')),
            ],
          ),
          SizedBox(height: 20),
  ...
  Widget _buildKunyeSatiri(String baslik, String deger, Color renk) {
    return Padding(
      ...
      child: Row(
        children: [
          SizedBox(width: 80, child: Text(baslik, style: TextStyle(color: Colors.white38, fontSize: 12, fontWeight: FontWeight.bold, fontFamily: 'Avenir'))),
  ...
  Widget _buildDevFiyatKutusu(double kdvliFiyat) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text("TOPLAM KDV DAHİL", style: TextStyle(color: Colors.white54, fontSize: 12, fontWeight: FontWeight.w900, letterSpacing: 1, fontFamily: 'Avenir')),
          SizedBox(height: 8),
          Text("₺${kdvliFiyat.toStringAsFixed(2)}", style: TextStyle(color: SiberTema.kanKirmizi, fontSize: 32, fontWeight: FontWeight.w900, letterSpacing: -1, fontFamily: 'Avenir')),
          SizedBox(height: 12),
          Container(
  ...
  Widget _buildVaryantMotoru() {
    return Padding(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text("Seçenekler", style: TextStyle(color: Colors.white, fontSize: 14, fontWeight: FontWeight.w900, fontFamily: 'Avenir')),
          SizedBox(height: 12),
          Row(
            children: [
              Expanded(
                ...
                child: Container(
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton<String>(
                      ...
                      isExpanded: true,
                      style: TextStyle(color: Colors.white, fontSize: 13, fontWeight: FontWeight.bold, fontFamily: 'Avenir'),
  ...
  Widget _buildGenisAciklamaPaneli() {
    return Padding(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text("Ürün Açıklaması", style: TextStyle(color: primaryCyan, fontSize: 16, fontWeight: FontWeight.w900, letterSpacing: 0.5, fontFamily: 'Avenir')),
          SizedBox(height: 12),
          Container(
            ...
            child: Text(aciklama, style: TextStyle(color: Colors.white70, fontSize: 13, height: 1.6, fontFamily: 'Avenir')),
          ),
        ],
      ),
    );
  ...
  Widget _buildRozetItem(IconData icon, String text) {
    return Expanded(
      child: Column(
        children: [
          Container(padding: EdgeInsets.all(12), decoration: BoxDecoration(color: Colors.white.withOpacity(0.05), shape: BoxShape.circle, border: Border.all(color: Colors.white10)), child: Icon(icon, color: primaryCyan, size: 24)),
          SizedBox(height: 8),
          Text(text, textAlign: TextAlign.center, style: TextStyle(color: Colors.white54, fontSize: 9, fontWeight: FontWeight.bold, height: 1.3, fontFamily: 'Avenir')),
        ],
      ),
    );
  }
      ...
      child: BackdropFilter(
        ...
        child: Container(
          ...
          child: ExpansionTile(
            ...
            title: Text(baslik, style: TextStyle(color: Colors.white, fontSize: 13, fontWeight: FontWeight.bold, fontFamily: 'Avenir')),
            children: [
              Padding(
                padding: EdgeInsets.all(20.0),
                child: Text(icerik, style: TextStyle(color: Colors.white54, fontSize: 12, height: 1.5, fontFamily: 'Avenir')),
              )
            ],
          ),
        ),
    ...
    return Column(
      ...
      children: [
        ...
        SizedBox(
          height: 240,
          child: ListView.builder(
            scrollDirection: Axis.horizontal, padding: EdgeInsets.symmetric(horizontal: 16), itemCount: 5, physics: BouncingScrollPhysics(),
            itemBuilder: (context, index) {
              return Container(
                width: 160, margin: EdgeInsets.symmetric(horizontal: 8),
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Container(height: 120, decoration: BoxDecoration(color: Colors.white.withOpacity(0.05), borderRadius: BorderRadius.vertical(top: Radius.circular(16)), image: DecorationImage(image: NetworkImage(resimUrl), fit: BoxFit.cover))),
                    Padding(
                      padding: EdgeInsets.all(12.0),
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text("120 NM Redüktörlü Kuantum Motor", style: TextStyle(color: Colors.white70, fontSize: 10, fontWeight: FontWeight.bold, fontFamily: 'Avenir'), maxLines: 2, overflow: TextOverflow.ellipsis),
                          SizedBox(height: 8),
                          Text("₺${(fiyat * 0.8).toStringAsFixed(2)}", style: TextStyle(color: primaryCyan, fontSize: 14, fontWeight: FontWeight.w900, fontFamily: 'Avenir')),
                        ],
                      ),
                    )
                  ],
      ...
      child: BackdropFilter(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [BoxShadow(color: primaryCyan.withOpacity(0.05), blurRadius: 20, offset: Offset(0, -5))],
          ),
          child: SafeArea(
            top: false,
            child: Row(
              children: [
                Column(
                  ...
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    Text("Toplam Tutar", style: TextStyle(color: Colors.white54, fontSize: 10, fontWeight: FontWeight.bold, fontFamily: 'Avenir')),
                    SizedBox(height: 4),
                    Text("₺${(kdvliFiyat * _adet).toStringAsFixed(2)}", style: TextStyle(color: primaryCyan, fontSize: 20, fontWeight: FontWeight.w900, letterSpacing: -0.5, fontFamily: 'Avenir')),
                  ],
                ),
                SizedBox(width: 24),
                Expanded(
                  child: SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("SİBER SEPETE EKLENDİ!"), backgroundColor: primaryCyan));
                      },
                      child: Text("SEPETE EKLE", style: TextStyle(fontWeight: FontWeight.w900, fontSize: 14, letterSpacing: 1.5, fontFamily: 'Avenir')),
                    ),
                  ),
                )
              ],
