...
// 🔥 SİBER KÖPRÜLER (Yeni İlan Ekranlarına Gidiş Rotaları)
...
class _OtoMarketScreenState extends State<OtoMarketScreen> with SingleTickerProviderStateMixin {
  ...
  // =======================================================================
  // 💎 TESLA MİMARİSİ: ŞIK ÖDEME (HAVUZ) PANELİ (YENİ %12 KURALINA GÖRE)
  // =======================================================================
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 16),
                  const Text("Siber Kasa Payı (%12) satıcının hakedişinden otonom olarak kesilecektir. Alıcı ek komisyon ödemez.", style: TextStyle(color: Colors.white38, fontSize: 10, height: 1.5)),
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                onPressed: () {
                  ...
                  _odemeMührü(ilanId, safFiyat, saticiId, saticiIsim); // Kuantum Fırlatması
                },
  ...
  Future<void> _odemeMührü(String ilanId, double fiyat, String saticiId, String saticiIsim) async {
  try {
...
Widget _fiyatSatiri(String baslik, String deger, Color renk, {bool isBold = false, bool isLarge = false}) {
  return Row(
      ...
      children: [
        Expanded(child: Text(baslik, style: TextStyle(color: isLarge ? Colors.white54 : renk, fontSize: isLarge ? 11 : 12, fontWeight: isBold ? FontWeight.bold : FontWeight.normal, letterSpacing: isLarge ? 1 : 0))),
...
Widget _buildOtoMarketSekmesi() {
  return Column(
    children: [
      ...
      Expanded(
        // 🚀 FİREBASE CANLI VERİ AKIŞI (Yeni ilanlar koleksiyonundan çeker)
          ...
          builder: (context, snapshot) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                String saticiId = veri['satici_id'] ?? "";
                String gercekSaticiAdi = veri['satici_isim'] ?? "Bireysel Satıcı";
                double fiyatDouble = (veri['brut_fiyat'] ?? 0).toDouble();
                int saticiPuani = 5; // Bunu ileride satıcı profilinden çekeriz
                ...
                return _buildParcaKarti(
                  ...
                  resimUrl: "https://via.placeholder.com/150/111111/00FFC2?text=OtoDNA",
                );
              },
            );
          },
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return _buildAracIlanKarti(
                  ...
                  resimUrl: "https://via.placeholder.com/300x150/111111/00FFC2?text=OtoDNA",
...
// 🚀 SİBER YÖNLENDİRME (KÖPRÜLER AKTİF)
      ...
      return Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildIlanSecenekKarti(
                "Yedek Parça & Aksesuar",
                "Bireysel ve kurumsal serbest piyasa ilanı oluşturun.",
            ...
            const SizedBox(height: 16),
            _buildIlanSecenekKarti(
                "Otomobil & Taşıt (Galeri)",
                "OtoDNA kalkanlı araçlarınızı siber ağa mühürleyin.",
