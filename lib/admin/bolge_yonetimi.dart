...
class AdminYetkiServisi {
  ...
  Future<Map<String, dynamic>> bolgeKomutaniAta({
    ...
    try {
      ...
      // (SetOptions merge: true ile diğer verilerini silmeden sadece yetkisini güncelleriz)
  ...
  Future<Map<String, dynamic>> komutanliktanIhracEt(String kullaniciId, String isim) async {
    try {
      ...
      // 2. Bölge komutanları listesinden durumu pasife çek (Geçmiş loglar için tamamen silmiyoruz)
