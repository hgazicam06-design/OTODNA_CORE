...
class SiberHizmetKutuphanesi {
  ...
  static const Map<String, List<String>> masterListe = {
    ...
    "Kaporta & Estetik": [
      ...
      "Oto Kuaför & Detaylı Temizlik" // Eklendi
    ],
    "Lojistik & Ticari": [
      ...
      "İş Makinesi Onarım & Hidrolik" // Genişletildi
    ],
    "Özel Sistemler & Yeni Nesil": [
      "Ekspertiz & Oto Test Merkezi", // Çok Kritik Eksik Kapatıldı
      "Elektrikli Araç (EV) & Hibrit Servisi", // Yeni Nesil Kritik Eksik Kapatıldı
      "EV Batarya Onarım & Değişim", // Yeni Nesil Kalkan
