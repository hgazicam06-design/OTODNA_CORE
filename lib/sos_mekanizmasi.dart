// lib/screens/sos_mekanizmasi.dart
import 'dart:async';
...
/// 5 saniye basılı tutulduğunda asılsız alarm filtresini geçer ve Matrix'e (Karargaha) kırmızı kod gönderir.
...
class _SiberAkilliSOSButonuState extends State<SiberAkilliSOSButonu> {
  ...
  Future<void> _sosMuhurleVeGonder() async {
    ...
    try {
      ...
      if (mounted) {
        _siberUyariGoster("KIZIL KOD GÖNDERİLDİ!", "Ekipler yolda. Konumunuz Ankara Merkez tarafından izleniyor.", _kanKirmizi);
      }
    } catch (e) {
      developer.log("🚨 AĞ ÇÖKTÜ: S.O.S fırlatılamadı!", error: e);
      if (mounted) {
        _siberUyariGoster("BAĞLANTI HATASI", "Sinyal iletilemedi, lütfen polisi arayın (112)!", _kanKirmizi);
      }
    }
  }
            ...
            children: [
              ...
              SizedBox(
                ...
                child: CircularProgressIndicator(
                  ...
                  color: _sosGonderildi ? _kuantumCyan : _kanKirmizi,
                ),
              ),
              // 🔴 ANA SİBER BUTON
              AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  color: _sosGonderildi ? _kuantumCyan.withOpacity(0.2) : _kanKirmizi.withOpacity(0.8),
                  shape: BoxShape.circle,
                  border: Border.all(color: _sosGonderildi ? _kuantumCyan : _kanKirmizi, width: 4),
                  boxShadow: [
                    BoxShadow(
                      color: (_sosGonderildi ? _kuantumCyan : _kanKirmizi).withOpacity(_deger > 0 ? 0.8 : 0.3),
                ...
                child: Column(
                  ...
                  children: [
                    Icon(
                      ...
                      color: _sosGonderildi ? _kuantumCyan : Colors.white,
                      size: 60,
                    ),
        ...
        if (_sosGonderildi)
          Container(
            ...
            child: const Text(
              ...
              textAlign: TextAlign.center,
              style: TextStyle(color: _kuantumCyan, fontWeight: FontWeight.bold, fontSize: 12, height: 1.5),
            ),
          )
        else
          Container(
            ...
            child: const Column(
              children: [
                Text("DİKKAT: ASILSIZ İHBAR CEZASI", style: TextStyle(color: Colors.redAccent, fontWeight: FontWeight.bold, fontSize: 11, letterSpacing: 1)),
                SizedBox(height: 8),
                Text(
