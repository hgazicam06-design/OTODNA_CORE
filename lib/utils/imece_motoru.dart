...
class SiberImeceMotoru {
  ...
  static Future<void> imeceIslemiKaydet({
    ...
    try {
      // 🛡️ SİBER ZIRH: Doğrudan referans oluşturarak Karargaha mühür vuruyoruz
      DocumentReference imeceRaporu = _db.collection('imece_operasyonlari').doc();

      await imeceRaporu.set({
