...
class _SiberCheckupTerminaliState extends State<SiberCheckupTerminali> {
  ...
  void _siberUyari(String mesaj, bool isError) {
    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
      content: Text(mesaj, style: TextStyle(color: SiberTema.oledBlack, fontWeight: FontWeight.w900, fontFamily: 'Avenir', fontSize: 11)),
    ...
    return ResponsiveKalkan(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: Colors.transparent,
          elevation: 0,
          title: Text("${widget.islemTuru.replaceAll('_', ' ')} KAYDI", style: TextStyle(color: SiberTema.textMain, fontWeight: FontWeight.w900, fontSize: 14, letterSpacing: 2, fontFamily: 'Avenir')),
          centerTitle: true,
          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                ...
                style: TextStyle(color: SiberTema.textMain, fontSize: 16, fontWeight: FontWeight.w900, fontFamily: 'Avenir'),
              ...
              Text("AKÜ DURUMU", style: TextStyle(color: SiberTema.textMuted, fontSize: 11, fontWeight: FontWeight.w900, letterSpacing: 2, fontFamily: 'Avenir')),
              SizedBox(height: 8),
              ...
              Text("MOTOR YAĞI SEVİYESİ", style: TextStyle(color: SiberTema.textMuted, fontSize: 11, fontWeight: FontWeight.w900, letterSpacing: 2, fontFamily: 'Avenir')),
              SizedBox(height: 8),
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  icon: _isProcessing
                      ...
                      : Icon(Icons.fingerprint, color: SiberTema.oledBlack),
                  label: Text(_isProcessing ? "MÜHÜRLENİYOR..." : "KAYDI VE SAĞLIK VERİSİNİ MÜHÜRLE", style: TextStyle(color: SiberTema.oledBlack, fontWeight: FontWeight.w900, fontSize: 12, letterSpacing: 1, fontFamily: 'Avenir')),
                ),
              )
            ],
          ),
