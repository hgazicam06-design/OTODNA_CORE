...
class SiberOnayKutusu extends StatefulWidget {
  ...
  SiberOnayKutusu({super.key, required this.onChanged});
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: _onayliMi 
            ...
            : [BoxShadow(color: Colors.white.withOpacity(0.02), blurRadius: 10, offset: Offset(0, 4))],
        ),
        child: Row(
          ...
          children: [
            ...
            AnimatedContainer(
              ...
              child: _onayliMi ? Icon(Icons.verified_user, color: SiberTema.kuantumCyan, size: 18) : null,
            ),
            SizedBox(width: 20),
...
class _AnalysisReportScreenState extends State<AnalysisReportScreen> {
  ...
  Future<void> _protokoluMuhurleVeGirisYap() async {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text("ERİŞİM YETKİSİ ONAYLANDI. AĞA GİRİLİYOR...", style: TextStyle(fontFamily: 'Avenir', fontWeight: FontWeight.bold)), backgroundColor: primaryTeal)
        );
    ...
    return ResponsiveKalkan(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text('A N A L İ Z   R A P O R U',
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Icon(Icons.security_update_good, color: primaryTeal, size: 64),
                ),
                SizedBox(height: 32),
                Text("ERİŞİM İZNİ BEKLENİYOR",
                    style: TextStyle(color: textMain, fontSize: 18, fontWeight: FontWeight.w900, letterSpacing: 2, fontFamily: 'Avenir')),
                SizedBox(height: 12),
                Text("Sisteme devam etmek için güvenlik protokolünü okuyup onaylamanız gerekmektedir.",
