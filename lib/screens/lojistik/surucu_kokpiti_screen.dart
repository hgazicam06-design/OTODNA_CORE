...
class _SurucuKokpitiScreenState extends State<SurucuKokpitiScreen> {
  ...
  void _rehberiGoster({bool otomatik = false}) {
    String baslik = "OTODNA SÜRÜCÜ KOKPİTİ";
    String icerik = "Şoför Karargahına Hoş Geldiniz.\n\n"
              ...
              children: [
                Expanded(
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(backgroundColor: Colors.transparent, foregroundColor: dangerColor, side: BorderSide(color: dangerColor), padding: EdgeInsets.symmetric(vertical: 16)),
                    child: Text("REDDET (-5 PUAN)", style: TextStyle(fontSize: 10, fontWeight: FontWeight.bold)),
                  ),
                ),
                SizedBox(width: 12),
                Expanded(
                  ...
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(backgroundColor: primaryTeal, foregroundColor: Colors.white, padding: EdgeInsets.symmetric(vertical: 16)),
                    child: Text("KABUL ET & GİT", style: TextStyle(fontSize: 14, fontWeight: FontWeight.w900)),
                  ),
                ),
              ],
            )
