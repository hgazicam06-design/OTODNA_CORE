...
class _AdminPanelSayfasiState extends State<AdminPanelSayfasi> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('G L O B A L   D E N E T İ M', style: TextStyle(color: Colors.white54, fontWeight: FontWeight.w900, fontSize: 11, letterSpacing: 3)),
        centerTitle: true,
        actions: [
          Container(
          ...
          Padding(
            ...
            child: StreamBuilder<DocumentSnapshot>(
                ...
                builder: (context, snapshot) {
                  // Eğer veritabanında henüz bu doküman yoksa yedek siber veriler (Mock) gösterilsin
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text("$_secilenUlke BÖLGE DAĞILIMI", style: const TextStyle(color: Colors.white, fontSize: 13, fontWeight: FontWeight.w900, letterSpacing: 1)),
                      const SizedBox(height: 4),
                      const Text("Kuantum Ağı Üzerindeki Mühür Sayıları", style: TextStyle(color: Colors.white38, fontSize: 10, fontWeight: FontWeight.bold)),
                    ],
                  ),
                ),
              ],
          ...
          Expanded(
            child: StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                // EĞER FİREBASE'DE VERİ YOKSA SİBER MOCK VERİLERİ (Görsellik bozulmasın diye)
                if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
                  List<Map<String, dynamic>> bolgeler = _secilenUlke == "TÜRKİYE"
                      ? [
                    {"ad": "İÇ ANADOLU", "muhur": 64}, {"ad": "MARMARA", "muhur": 42},
                    {"ad": "EGE", "muhur": 28}, {"ad": "AKDENİZ", "muhur": 12},
                    {"ad": "KARADENİZ", "muhur": 8}
                  ]
                      : [
                    {"ad": "BAVYERA", "muhur": 14}, {"ad": "KUZEY ALMANYA", "muhur": 8},
                    {"ad": "HESSEN", "muhur": 6}
                  ];
  ...
  // 💎 YARDIMCI BİLEŞEN: ÜLKE SEKMESİ (Glow ve Animasyonlu)
  ...
  // 💎 YARDIMCI BİLEŞEN: BÖLGE LİSTE SATIRI
      ...
      child: Row(
        children: [
          ...
          Column(
            ...
            children: [
              Text(muhurSayisi.toString(), style: const TextStyle(color: primaryCyan, fontSize: 18, fontWeight: FontWeight.w900)),
