...
class _AnaEkranState extends ConsumerState<AnaEkran> with TickerProviderStateMixin {
  ...
  final Color bgColor = Color(0xFFF4F6F8);
  final Color surfaceColor = Colors.white;
  final Color primaryTeal = Color(0xFF005A64);
  final Color secondaryTeal = Color(0xFF009688);
  final Color textMain = Color(0xFF1E293B);
  final Color textMuted = Color(0xFF64748B);
  final Color dangerColor = Color(0xFFD32F2F);
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              GestureDetector(
                onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => AracKayitScreen())),
                child: Row(
                  children: [
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        gradient: LinearGradient(
          colors: [primaryTeal, Color(0xFF003D47)],
              ...
              children: [
                Row(
                  ...
                  children: [
                    Row(
                      children: [
                        Icon(Icons.memory, color: Color(0xFFFFD700), size: 24),
                        SizedBox(width: 8),
        ...
        children: [
          ...
          if (rol == 'bayi' || rol == 'admin')
            _kurumsalHizliIslem(Icons.handshake, "Servis", () {
              Navigator.push(context, MaterialPageRoute(builder: (_) => OtoDnaKategoriMotoru()));
            }),
        ],
      ),
    );
  ...
  Widget _buildAltNav() => Container(
    decoration: BoxDecoration(
      ...
      boxShadow: [BoxShadow(color: Colors.white.withOpacity(0.05), blurRadius: 20, offset: Offset(0, -5))]
    ),
    child: BottomNavigationBar(
      ...
      selectedLabelStyle: TextStyle(fontSize: 9, fontWeight: FontWeight.w900, letterSpacing: 1, fontFamily: 'Avenir'),
      unselectedLabelStyle: TextStyle(fontSize: 9, fontWeight: FontWeight.bold, letterSpacing: 1, fontFamily: 'Avenir'),
