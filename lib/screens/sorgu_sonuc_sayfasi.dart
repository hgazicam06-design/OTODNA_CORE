      ...
      child: Scaffold(
          ...
          child: Center(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 24),
                Text("ARAÇ DNA'SI ÇÖZÜMLENDİ", style: TextStyle(color: SiberTema.textMain, fontSize: 18, fontWeight: FontWeight.w900, letterSpacing: 2, fontFamily: 'Avenir')),
                SizedBox(height: 12),
                Text("ŞASE: ${widget.saseNo}", style: TextStyle(color: SiberTema.kuantumCyan, fontSize: 14, fontWeight: FontWeight.bold, letterSpacing: 3, fontFamily: 'monospace')),
        ...
        floatingActionButton: FloatingActionButton.extended(
          ...
          label: Text(
            ...
            style: TextStyle(fontSize: 12, fontWeight: FontWeight.w900, letterSpacing: 1.5, color: SiberTema.textMain, fontFamily: 'Avenir'),
          ),
