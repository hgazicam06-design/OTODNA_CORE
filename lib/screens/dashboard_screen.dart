        ...
        actions: [
          Padding(
            ...
            child: OutlinedButton.icon(
              ...
              icon: Icon(Icons.radar, color: Colors.orangeAccent, size: 18),
              label: Text("SİSTEMİ TARA", style: TextStyle(color: Colors.orangeAccent, fontSize: 10, fontWeight: FontWeight.w900, letterSpacing: 1)),
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              style: TextStyle(color: SiberTema.textMain, fontSize: 13, fontWeight: FontWeight.w900, letterSpacing: 1.5),
            ),
            SizedBox(height: 8),
            Text(
              subtitle,
              textAlign: TextAlign.center,
              style: TextStyle(color: SiberTema.textMuted, fontSize: 10, fontWeight: FontWeight.bold, letterSpacing: 1),
            ),
          ],
        ),
      ),
  ...
  Widget _dummyScreen(String title) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.transparent,
        elevation: 0,
        title: Text(title, style: TextStyle(color: primaryCyan, fontSize: 14, fontWeight: FontWeight.w900, letterSpacing: 1.5)),
