...
class SiberFormMerkeziScreen extends StatefulWidget {
  SiberFormMerkeziScreen({super.key});
...
class _SiberFormMerkeziScreenState extends State<SiberFormMerkeziScreen> with SingleTickerProviderStateMixin {
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 32),
            Row(children: [
              Container(padding: EdgeInsets.all(12), decoration: BoxDecoration(color: Colors.redAccent.withValues(alpha: 0.1), shape: BoxShape.circle), child: Icon(Icons.warning_amber_rounded, color: Colors.redAccent, size: 28)), 
              SizedBox(width: 16), 
            ...
            SizedBox(height: 16),
            Text("Klasik kağıt tutanaklara son! Kazaya karışan aracın QR kimliğini okutarak saniyeler içinde yasal süreci başlatın.", style: TextStyle(color: Colors.white54, fontSize: 13, height: 1.5, fontWeight: FontWeight.bold, fontFamily: 'Avenir')),
            SizedBox(height: 32),
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                label: Text("TUTANAĞI BAŞLAT", style: TextStyle(fontWeight: FontWeight.w900, fontSize: 13, letterSpacing: 1, fontFamily: 'Avenir')),
              ),
            )
          ],
        ),
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          SizedBox(width: 16),
          Expanded(child: Text(aciklama, style: TextStyle(color: Colors.white70, fontSize: 12, fontWeight: FontWeight.bold, fontFamily: 'Avenir'))),
        ],
      ),
    );
  }
          ...
          Padding(
            ...
            child: Container(
              ...
              child: TabBar(
                ...
                tabs: [Tab(text: "Tutanak"), Tab(text: "Onay"), Tab(text: "Randevu")],
              ),
            ),
          ),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(24), border: Border.all(color: primaryTeal.withValues(alpha: 0.3)), boxShadow: [BoxShadow(color: primaryTeal.withValues(alpha: 0.05), blurRadius: 15, offset: Offset(0, 5))]),
                        child: Row(
                          children: [
                            Container(
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(height: 8),
                                  Text("Saat: 14:30 • Şikayet: Standart Bakım", style: TextStyle(color: Colors.white54, fontSize: 11, fontWeight: FontWeight.bold, fontFamily: 'Avenir')),
                                ],
                              ),
                            ),
  ...
  Widget _buildFormKarti(String baslik, String aciklama, IconData ikon, Color renk, VoidCallback onTap) {
    return GestureDetector(
      onTap: onTap,
      child: Container(
        margin: EdgeInsets.only(bottom: 16), padding: EdgeInsets.all(24),
        decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(20), border: Border.all(color: Colors.white.withValues(alpha: 0.05)), boxShadow: [BoxShadow(color: Colors.white.withValues(alpha: 0.02), blurRadius: 10, offset: Offset(0, 5))]),
        child: Row(
          children: [
            Container(
                padding: EdgeInsets.all(16),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 8),
                  Text(aciklama, style: TextStyle(color: Colors.white54, fontSize: 11, height: 1.4, fontWeight: FontWeight.bold, fontFamily: 'Avenir')),
                ],
              ),
            ),
            SizedBox(width: 12),
  ...
  Widget _buildTeklifKarti(String firma, String islem, String fiyat, String durum) {
    return Container(
      ...
      decoration: BoxDecoration(
          ...
          boxShadow: [BoxShadow(color: Colors.orange.withValues(alpha: 0.05), blurRadius: 20, offset: Offset(0, 5))]
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Row(
            ...
            children: [
              Row(
                children: [
                  Icon(Icons.business_outlined, color: Colors.white54, size: 20),
                  SizedBox(width: 8),
                  Text(firma, style: TextStyle(color: textColor, fontWeight: FontWeight.w900, fontSize: 14, fontFamily: 'Avenir')),
                ],
              ),
              Container(padding: EdgeInsets.symmetric(horizontal: 10, vertical: 6), decoration: BoxDecoration(color: Colors.orange.withValues(alpha: 0.1), borderRadius: BorderRadius.circular(8), border: Border.all(color: Colors.orange.withValues(alpha: 0.5))), child: Text(durum, style: TextStyle(color: Colors.orange, fontSize: 9, fontWeight: FontWeight.w900, letterSpacing: 1, fontFamily: 'Avenir'))),
            ],
          ),
          SizedBox(height: 24),
          Text(islem, style: TextStyle(color: Colors.white70, fontSize: 14, height: 1.4, fontWeight: FontWeight.bold, fontFamily: 'Avenir')),
          SizedBox(height: 20),
          ...
          Row(
            ...
            children: [
              ...
              Row(
                children: [
                  TextButton(onPressed: () {}, child: Text("REDDET", style: TextStyle(color: Colors.white38, fontSize: 11, fontWeight: FontWeight.w900, letterSpacing: 1, fontFamily: 'Avenir'))),
                  SizedBox(width: 8),
                  ElevatedButton(
                      ...
                      onPressed: () {},
                      child: Text("ONAYLA", style: TextStyle(fontWeight: FontWeight.w900, fontSize: 11, letterSpacing: 1, fontFamily: 'Avenir'))
                  ),
                ],
              )
            ],
