...
class SiberAiAyarlariScreen extends StatefulWidget {
  SiberAiAyarlariScreen({super.key});
...
class _SiberAiAyarlariScreenState extends State<SiberAiAyarlariScreen> {
  ...
  void _ayarlariKaydet() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text("$asistanIsmi: 'Ayarlarım güncellendi.'", style: TextStyle(color: SiberTema.textMain, fontWeight: FontWeight.bold, fontFamily: 'Avenir')), 
      ...
      builder: (context) => AlertDialog(
        ...
        title: Row(
          children: [
            ...
            SizedBox(width: 12),
            Text("SES AKTİF", style: TextStyle(color: Color(0xFF1E293B), fontSize: 13, fontWeight: FontWeight.w900, letterSpacing: 1.5, fontFamily: 'Avenir')),
          ],
        ),
        content: Text("Oynatma Hızı: ${_konusmaHizi.toStringAsFixed(2)}x\n\n\"$mesaj\"", style: TextStyle(color: Colors.white70, fontSize: 13, fontStyle: FontStyle.italic, height: 1.5, fontFamily: 'Avenir')),
        actions: [
          TextButton(onPressed: () {
            _flutterTts.stop();
            Navigator.pop(context);
          }, child: Text("SUSTUR VE KAPAT", style: TextStyle(color: Colors.white54, fontSize: 11, fontWeight: FontWeight.bold, letterSpacing: 1, fontFamily: 'Avenir')))
        ],
      ),
    );
  }
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 8),
            Text("Yapay zeka asistanınızın ismini, sesini, hızını ve müdahale tarzını kişiselleştirin.", style: TextStyle(color: Colors.white54, fontSize: 13, height: 1.5, fontWeight: FontWeight.bold, fontFamily: 'Avenir')),
            SizedBox(height: 40),

            // 1. İSİM ALANI
            Text("1. Asistan Kimliği", style: TextStyle(color: Colors.white54, fontSize: 12, fontWeight: FontWeight.w900, letterSpacing: 1, fontFamily: 'Avenir')),
            SizedBox(height: 12),
            Container(
              ...
              child: TextField(
                  ...
                  decoration: InputDecoration(
                      ...
                      hintStyle: TextStyle(color: Colors.white24, fontWeight: FontWeight.bold, fontSize: 14, fontFamily: 'Avenir'),
            ...
            // 2. SES SEÇİMİ
            Text("2. Ses Profili", style: TextStyle(color: Colors.white54, fontSize: 12, fontWeight: FontWeight.w900, letterSpacing: 1, fontFamily: 'Avenir')),
            SizedBox(height: 16),
            Row(
                children: [
            ...
            // 4. MÜDAHALE TARZI
            Text("4. Müdahale Tarzı", style: TextStyle(color: Colors.white54, fontSize: 12, fontWeight: FontWeight.w900, letterSpacing: 1, fontFamily: 'Avenir')),
            SizedBox(height: 16),
            GestureDetector(
                onTap: () => setState(() => _cozumTarzi = "HIZLI"),
                child: Container(
                    padding: EdgeInsets.all(20), margin: EdgeInsets.only(bottom: 12),
                  ...
                  Expanded(
                      ...
                      child: SizedBox(
                        ...
                        child: OutlinedButton.icon(
                            ...
                            label: Text("SESİ TEST ET", style: TextStyle(fontSize: 12, fontWeight: FontWeight.w900, letterSpacing: 1, fontFamily: 'Avenir'))
                        ),
                      )
                  ),
                  SizedBox(width: 16),
                  Expanded(
                      ...
                      child: SizedBox(
                        ...
                        child: ElevatedButton.icon(
                            ...
                            label: Text("KAYDET", style: TextStyle(fontWeight: FontWeight.w900, fontSize: 12, letterSpacing: 1, fontFamily: 'Avenir'))
                        ),
                      )
                  )
                ]
