...
class SiberForumSayfasi extends StatelessWidget {
  ...
  SiberForumSayfasi({super.key, required this.kullaniciId});
  ...
  Widget _buildAdminAraclari(BuildContext context, String rol, Color dangerColor, Color textColor) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [BoxShadow(color: dangerColor.withValues(alpha: 0.05), blurRadius: 20, offset: Offset(0, 5))],
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text("Yetki Seviyesi: $rol", style: TextStyle(color: Colors.white54, fontWeight: FontWeight.bold, fontSize: 10, fontFamily: 'Avenir')),
                  ],
                ),
              ),
            ],
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              onPressed: () {
                ...
                ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Yönetim Terminali Başlatılıyor...'), backgroundColor: dangerColor));
              },
              icon: Icon(Icons.gavel),
              label: Text("YÖNETİM YETKİLERİNİ KULLAN", style: TextStyle(fontWeight: FontWeight.w900, letterSpacing: 1.5, fontFamily: 'Avenir')),
