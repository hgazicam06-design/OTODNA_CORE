...
class IlanVerEkspertizScreen extends StatefulWidget {
  ...
  IlanVerEkspertizScreen({super.key, required this.secilenArac});
...
class _IlanVerEkspertizScreenState extends State<IlanVerEkspertizScreen> {
  ...
  void _siberSenkronizasyonBaslat() {
    ...
    if (_otodnaSenkronizasyon) {
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Plaza Ağ Taraması Başladı... 📡", style: TextStyle(fontFamily: 'Avenir', fontWeight: FontWeight.bold)), backgroundColor: Colors.teal.shade700));
      Future.delayed(Duration(milliseconds: 1500), () {
        ...
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Geçmiş Eşleşti: 1 Değişen, 1 Boyalı! 🛑", style: TextStyle(fontFamily: 'Avenir', fontWeight: FontWeight.bold)), backgroundColor: Colors.redAccent));
      });
    } else {
      setState(() {
          ...
          return Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 24),
                Text("$parca Durumu", style: TextStyle(color: Color(0xFF1E293B), fontSize: 20, fontWeight: FontWeight.w900, letterSpacing: -0.5, fontFamily: 'Avenir')),
                SizedBox(height: 8),
                Text("Seçtiğiniz parçanın ekspertiz sonucunu işaretleyin.", style: TextStyle(color: Colors.white54, fontSize: 13, fontFamily: 'Avenir', fontWeight: FontWeight.bold)),
                SizedBox(height: 24),
  ...
  void _devamEt() {
    ...
    if (_kullaniciFiyatController.text.trim().isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Lütfen hedef satış fiyatınızı girin.", style: TextStyle(color: SiberTema.textMain, fontFamily: 'Avenir')), backgroundColor: Colors.redAccent));
      return;
    }
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 8),
                    Text("${widget.secilenArac.join(' > ')}\nAracın kaporta durumunu dijital şemaya işleyin.", style: TextStyle(color: Colors.white54, fontSize: 13, height: 1.5, fontWeight: FontWeight.bold, fontFamily: 'Avenir')),
                    SizedBox(height: 32),
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 4),
                                Text("Aracın OtoDNA'daki mühürlü geçmişini haritaya otomatik yansıt.", style: TextStyle(color: Colors.white54, fontSize: 11, height: 1.4, fontWeight: FontWeight.bold, fontFamily: 'Avenir')),
                              ],
                            ),
                          ),
                          Switch(
                        ...
                        child: Column(
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                _buildAracParcasi("Sol Ön Çamurluk", 32, 80, BorderRadius.only(topLeft: Radius.circular(20), bottomLeft: Radius.circular(4))),
                                SizedBox(width: 6),
                                _buildAracParcasi("Kaput", 96, 80, BorderRadius.circular(8)),
                                SizedBox(width: 6),
                                _buildAracParcasi("Sağ Ön Çamurluk", 32, 80, BorderRadius.only(topRight: Radius.circular(20), bottomRight: Radius.circular(4))),
                              ],
                            ),
                            SizedBox(height: 6),
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                SizedBox(width: 108), // Tavan genişliği (96) + boşluklar (12)
                            ...
                            Row(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                _buildAracParcasi("Sol Arka Çamurluk", 32, 80, BorderRadius.only(topLeft: Radius.circular(4), bottomLeft: Radius.circular(20))),
                                SizedBox(width: 6),
                                _buildAracParcasi("Bagaj", 96, 80, BorderRadius.circular(8)),
                                SizedBox(width: 6),
                                _buildAracParcasi("Sağ Arka Çamurluk", 32, 80, BorderRadius.only(topRight: Radius.circular(4), bottomRight: Radius.circular(20))),
                              ],
                            ),
                            SizedBox(height: 6),

                            // ARKA TAMPON
                            _buildAracParcasi("Arka Tampon", 140, 24, BorderRadius.vertical(bottom: Radius.circular(30))),
                          ],
                        ),
                      ),
                    ),
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Icon(Icons.circle_outlined, color: Colors.white24, size: 14), SizedBox(width: 6), Text("Orijinal", style: TextStyle(color: Colors.white54, fontSize: 11, fontWeight: FontWeight.bold, fontFamily: 'Avenir')), SizedBox(width: 16),
                        Icon(Icons.circle, color: Colors.orange, size: 14), SizedBox(width: 6), Text("Boyalı", style: TextStyle(color: Colors.white54, fontSize: 11, fontWeight: FontWeight.bold, fontFamily: 'Avenir')), SizedBox(width: 16),
                        Icon(Icons.circle, color: Colors.redAccent, size: 14), SizedBox(width: 6), Text("Değişen", style: TextStyle(color: Colors.white54, fontSize: 11, fontWeight: FontWeight.bold, fontFamily: 'Avenir')),
                      ],
                    ),
                    SizedBox(height: 48),
                    ...
                    // =========================================================
                    Text("Yapay Zeka Piyasa Analizi", style: TextStyle(color: Colors.white54, fontSize: 12, fontWeight: FontWeight.bold, letterSpacing: 1, fontFamily: 'Avenir')),
                    SizedBox(height: 8),
                    AnimatedSwitcher(
                    ...
                    Container(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          labelStyle: TextStyle(color: Colors.white54, fontSize: 13, fontWeight: FontWeight.bold, fontFamily: 'Avenir'),
              ...
              child: SafeArea(
                child: SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: _devamEt,
                    child: Text("FİYATI ONAYLA VE DEVAM ET", style: TextStyle(fontWeight: FontWeight.w900, fontSize: 14, letterSpacing: 1, fontFamily: 'Avenir')),
                  ),
                ),
              ),
            )
