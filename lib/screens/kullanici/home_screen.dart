...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Color premiumGold = Color(0xFFD4AF37);
  ...
  Widget _buildPlazaKarsilama(Color primaryTeal, Color textColor) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(color: Colors.white.withValues(alpha: 0.02), blurRadius: 20, offset: Offset(0, 8))
        ]
      ),
      child: Row(
        children: [
      ...
      child: InkWell(
        ...
        child: Container(
          decoration: BoxDecoration(
            ...
            border: Border.all(color: Colors.white.withValues(alpha: 0.05)),
            boxShadow: [
              BoxShadow(color: Colors.white.withValues(alpha: 0.02), blurRadius: 10, offset: Offset(0, 4))
            ]
          ),
          child: Column(
