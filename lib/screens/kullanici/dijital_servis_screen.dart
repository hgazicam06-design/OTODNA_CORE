...
class _DijitalServisScreenState extends State<DijitalServisScreen> {
  ...
  void _gorseldenParcaAra() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        title: Row(children: [Icon(Icons.camera_alt_outlined, color: Colors.teal.shade700), SizedBox(width: 8), Text("Siber Vizyon", style: TextStyle(color: Color(0xFF1E293B), fontSize: 16, fontFamily: 'Avenir', fontWeight: FontWeight.bold))]),
        content: Text("Kameranız üzerinden arızalı parçayı veya OEM kodunu taratarak küresel ağda eşleşme arayın.", style: TextStyle(color: Colors.white54, fontSize: 13, height: 1.5, fontFamily: 'Avenir')),
        actions: [
          ...
          ElevatedButton(
            ...
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Lens Aktif Ediliyor...', style: TextStyle(color: SiberTema.textMain)), backgroundColor: Colors.teal.shade700));
            },
  ...
  void _islemSecimi(String parcaAdi, bool videoIstiyorMu) {
    showModalBottomSheet(
      ...
      builder: (context) => Container(
        ...
        decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.vertical(top: Radius.circular(24)), border: Border(top: BorderSide(color: Colors.white.withValues(alpha: 0.05))), boxShadow: [BoxShadow(color: Colors.white.withValues(alpha: 0.1), blurRadius: 20)]),
        child: Column(
          mainAxisSize: MainAxisSize.min,
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(parcaAdi, style: TextStyle(color: Color(0xFF1E293B), fontSize: 20, fontWeight: FontWeight.w900, letterSpacing: -0.5, fontFamily: 'Avenir')),
            SizedBox(height: 8),
            Text("Bu parçanın dijital genetiğine işlenecek işlemi seçin.", style: TextStyle(color: Colors.white54, fontSize: 13, fontFamily: 'Avenir')),
            SizedBox(height: 24),
            Row(
            ...
            if (videoIstiyorMu) ...[
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  onPressed: () {
                    Navigator.pop(context);
                    ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Kamera Açılıyor...', style: TextStyle(color: SiberTema.textMain)), backgroundColor: Colors.teal.shade700));
                  },
  ...
  Widget _buildIslemButonu(IconData icon, String text, Color color) {
    return InkWell(
      onTap: () {
        Navigator.pop(context);
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Sisteme işlendi.'), backgroundColor: Colors.green));
      },
          ...
          children: [
            ...
            InkWell(
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    Container(padding: EdgeInsets.all(12), decoration: BoxDecoration(color: primaryTeal.withValues(alpha: 0.1), shape: BoxShape.circle), child: Icon(Icons.document_scanner_outlined, color: primaryTeal, size: 32)),
                    SizedBox(width: 20),
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          ...
                          SizedBox(height: 4),
                          Text("Arızalı OEM kodunu kameraya okutun.", style: TextStyle(color: Colors.white54, fontSize: 12, fontFamily: 'Avenir')),
                        ],
                      ),
                    ),
            ...
            // KATEGORİLER
            ListView.builder(
              shrinkWrap: true, physics: NeverScrollableScrollPhysics(), itemCount: _servisKategorileri.length,
                ...
                return Container(
                  ...
                  child: Theme(
                    ...
                    child: ExpansionTile(
                      ...
                      children: [
                        Container(
                          padding: EdgeInsets.only(left: 16, right: 16, bottom: 8), decoration: BoxDecoration(color: bgColor, borderRadius: BorderRadius.vertical(bottom: Radius.circular(12)), border: Border(top: BorderSide(color: Colors.white.withValues(alpha: 0.05)))),
                          child: Column(
                            children: (kategori['alt_kategoriler'] as List<String>).map((parca) {
                              return ListTile(
                                contentPadding: EdgeInsets.symmetric(horizontal: 8, vertical: 0),
                                title: Text(parca, style: TextStyle(color: Colors.white70, fontSize: 13, fontWeight: FontWeight.w600, fontFamily: 'Avenir')),
