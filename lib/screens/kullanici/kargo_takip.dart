...
class SiberKargoTakipEkrani extends StatelessWidget {
  ...
  SiberKargoTakipEkrani({super.key, required this.siparisId});
              ...
              Row(
                ...
                children: [
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text("LOJİSTİK DURUMU", style: TextStyle(color: Colors.white54, fontSize: 10, letterSpacing: 2, fontWeight: FontWeight.bold, fontFamily: 'Avenir')),
                      SizedBox(height: 4),
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        SizedBox(width: 8),
                        Text(takipKodu, style: TextStyle(color: Color(0xFF1E293B), fontWeight: FontWeight.w900, fontSize: 12, letterSpacing: 1, fontFamily: 'Avenir')),
                      ],
                    ),
                  ),
                ],
