    ...
    return ResponsiveKalkan(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text("USTA KOMUTA MERKEZİ", style: TextStyle(color: SiberTema.textMuted, fontSize: 11, fontWeight: FontWeight.w900, letterSpacing: 2, fontFamily: 'Avenir')),
          actions: [
            IconButton(
          ...
          child: SafeArea(
            child: Center(
              child: ConstrainedBox(
                constraints: BoxConstraints(maxWidth: 800), // 🖥️ Web / Tablet Kalkanı
                child: Column(
                              ...
                              child: Row(
                                children: [
                                  Container(
                                    ...
                                    child: Icon(Icons.qr_code_scanner, color: SiberTema.altinSari, size: 32),
                                  ),
                                  SizedBox(width: 20),
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        Text("HIZLI STOK VE ARAÇ TARAMA", style: TextStyle(color: SiberTema.altinSari, fontSize: 12, fontWeight: FontWeight.w900, letterSpacing: 1.5, fontFamily: 'Avenir')),
                                        SizedBox(height: 6),
                                  ...
                                  Icon(Icons.arrow_forward_ios, color: SiberTema.altinSari, size: 16),
                                ],
                              ),
                            ),
                          ),
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          SizedBox(width: 12),
                          Text("AKTİF SİBER RANDEVULAR (₺200 TEMİNATLI)", style: TextStyle(color: SiberTema.textMuted, fontSize: 10, fontWeight: FontWeight.w900, letterSpacing: 1.5, fontFamily: 'Avenir')),
                        ],
                      ),
                    ),
                    Padding(
          ...
          Column(
            children: [
              Container(
                ...
                child: Icon(Icons.person, color: SiberTema.kuantumCyan, size: 24),
              ),
              SizedBox(height: 12),
              Text(saat, style: TextStyle(color: SiberTema.kuantumCyan, fontSize: 14, fontWeight: FontWeight.w900, fontFamily: 'monospace')),
            ],
          ),
          SizedBox(width: 20),
            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    Expanded(child: Text(isim.toUpperCase(), style: TextStyle(color: SiberTema.textMain, fontSize: 13, fontWeight: FontWeight.w900, letterSpacing: 1.5, fontFamily: 'Avenir'))),
                    Container(
                      ...
                      child: Text(plaka, style: TextStyle(color: SiberTema.textMuted, fontSize: 9, fontWeight: FontWeight.bold, letterSpacing: 1, fontFamily: 'Avenir')),
                    ),
                  ],
                ),
                SizedBox(height: 8),
                  ...
                  children: [
                    Expanded(
                      child: OutlinedButton(
                        ...
                        child: Text("İPTAL ET", style: TextStyle(color: SiberTema.kanKirmizi, fontSize: 9, fontWeight: FontWeight.w900, letterSpacing: 1, fontFamily: 'Avenir')),
                      ),
                    ),
                    SizedBox(width: 12),
                    Expanded(
                      child: ElevatedButton(
                        ...
                        child: Text("İŞLEME AL", style: TextStyle(fontSize: 9, fontWeight: FontWeight.w900, letterSpacing: 1, fontFamily: 'Avenir')),
                      ),
                    ),
                  ],
                ),
