  ...
  Widget build(BuildContext context) {
    return ResponsiveKalkan(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: Text("KUANTUM BAYİ TERMİNALİ", style: TextStyle(color: SiberTema.kuantumCyan, fontWeight: FontWeight.w900, letterSpacing: 2, fontSize: 13)),
          backgroundColor: Colors.transparent,
          elevation: 0,
          ...
          children: [
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  Text("SİBER İSTİHBARAT ÖZETİ", style: TextStyle(color: SiberTema.textMuted, fontSize: 10, letterSpacing: 2, fontWeight: FontWeight.w900)),
                  SizedBox(height: 12),
  ...
  Widget _buildSakinRadarSimulasyonu() {
    return Column(
      ...
      children: [
        ...
        SizedBox(height: 16),
        Text("RADAR TEMİZ. YAKINDA S.O.S SİNYALİ YOK.", style: TextStyle(color: SiberTema.kuantumCyan, letterSpacing: 1, fontSize: 10, fontWeight: FontWeight.bold)),
      ],
    );
  }
  ...
  Widget _buildKirmiziAlarmKarti(int sinyalSayisi) {
    return Column(
      ...
      children: [
        ...
        SizedBox(height: 16),
        Text("🚨 $sinyalSayisi AKTİF S.O.S SİNYALİ 🚨", style: TextStyle(color: SiberTema.textMain, fontWeight: FontWeight.w900, fontSize: 14, letterSpacing: 2)),
        SizedBox(height: 8),
        ElevatedButton(
          ...
          child: Text("MÜDAHALE ET", style: TextStyle(fontWeight: FontWeight.w900, letterSpacing: 1)),
        )
      ],
    );
  }
      ...
      builder: (context, snapshot) {
        ...
        return Container(
          ...
          child: ListTile(
            ...
            title: Text(baslik, style: TextStyle(color: SiberTema.textMain, fontWeight: FontWeight.w900, letterSpacing: 1, fontSize: 11)),
            trailing: Container(
